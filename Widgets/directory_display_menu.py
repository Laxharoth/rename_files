...
def directory_display_menu(
    root: Misc, filetree: FileTree, position: Literal["left", "right", "top", "bottom"]
):
    ...
    def fill_directory_display_menu(event: DirectoryChangeEvent):
        ...
        fill_directory_display_menu_recursive(
            "", Path(file_tree.root_directory.file_route)
        )
    ...
    event_manager.attach(EventEnum.DIRECTORY_CHANGED, fill_directory_display_menu)
